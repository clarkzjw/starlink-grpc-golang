...
The [protoset](./protoset/) directory contains the archived protosets from the Starlink firmware.

The [proto](./proto/) directory contains the decoded protobuf files from the Starlink protosets.
