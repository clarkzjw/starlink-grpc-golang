...
```
REBOOT_REASON_HARD_POWER_DOWN = 100;
REBOOT_REASON_ERROR_FILE_MISSING = 200;
REBOOT_REASON_ERROR_CRC_MISMATCH = 201;
REBOOT_REASON_ERROR_EDR_TIMEOUT = 202;
REBOOT_REASON_ERROR_UNSUPPORTED_VERSION = 203;
REBOOT_REASON_ERROR_BOOT_COUNT_MISMATCH = 204;
```
...
[WiFi] New event type `EVENT_REASON_ROUTER_MESH_CONNECTION_CHANGING`

+ 2026.01.02.mr71031

[Dish] New event log reason `EVENT_REASON_CLIENT_SWITCHING_BAND`, `EVENT_REASON_CLIENT_SWITCHING_UPSTREAM_MAC`.
